...
//const patientdetailsOutputData = JSON.parse(JSON.stringify(require("../../../TestData/PatientDomain/PatientDetailsOutput.json.json")))
...
// const myFunction = require("../../../DBConnection/Database");
// const query = 'select * from Patients order by pat_Id desc limit 1';
...
test('Register New Patient @Functional @Regression', async ({ page }) => {
  ...
  //await myFunction.GetDataFromJson(query)
