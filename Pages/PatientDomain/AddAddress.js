class AddAddress
{
    constructor(page)
    {
        ...
        this.txtbox_TempMobileNumber=page.getByTestId('Mobile').nth(1)
    ...
    async enterTownInAddress(add_address2)
    {
        await this.txtbox_town.fill(add_address2)
    }
    async enterDestrict(add_address5)
    {
        await this.txtbox_district.fill(add_address5)
    }
    async enterCounty(add_address6)
    {
        await this.txtbox_county.fill(add_address6)
    }
    async enterPostCode(add_postcode)
    {
        await this.txtbox_postcode.fill(add_postcode)
    }
    ...
    {
        await this.txtbox_PopupCountry.fill("India")
    }
    ...
    async enterTempTown(add_address2)
    {
        await this.txtbox_temptown.type(add_address2)
    }
    async enterTempDistrict(add_address5)
    {
        await this.txtbox_tempDistrict.type(add_address5)
    }
    async enterTempCounty(add_address6)
    {
        await this.txtbox_tempCounty.type(add_address6)
    }
    async enterTempPostcode(add_postcode)
    {
        await this.txtbox_PostCode.type(add_postcode)
    }
   ...
   async selectTempCountry()
   {
    ...
    {
        await this.txtbox_tempICAOCountryCode.type("IP12")
    }
    async enterTempPhone(name)
    {
        await this.txtbox_tempPhone.type(name)
    }

    async enterTempEmail(name)
    {
        await this.txtbox_tempEmail.type(name)
    }
    
    async enterTempMobileNumber()
    {
        await this.txtbox_TempMobileNumber.type('9890098214')
    }
    async enterTempWorkPhone(name)
    {
        await this.txtbox_tempWorkPhone.type(name)
    }
    async enterTempFax(name)
    {
        await this.txtbox_tempFax.type(name)
    }
    ...
    {
        await this.txtbox_TempAddressNotes.type("Added Temp Address Notes.")
